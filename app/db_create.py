...
def add_nodes():
    data = [
        ...
        Nodes(name="Neva", ip="192.168.1.50", interface="physical", device_type="laptop"),
        Nodes(name="Lesko", ip="192.168.1.51", interface="physical", device_type="laptop"),
        ...
        Nodes(name="Server234", ip="192.168.1.234", interface="physical", device_type="laptop"),
        Nodes(name="Router - gateway", ip="192.168.2.1", interface="WiFi"),
        Nodes(name="Neva phone", ip="192.168.2.3", interface="WiFi", device_type="handheld"),
        Nodes(name="Neva PC", ip="192.168.2.4", interface="WiFi", device_type="laptop"),
        Nodes(name="Lesko phone", ip="192.168.2.5", interface="WiFi", device_type="handheld"),
    ]
    for node in data:
        db.session.add(node)
        db.session.commit()
